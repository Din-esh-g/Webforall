...
namespace NewProjectAPI.Controllers
{
  ...
  public class PhotosController : ControllerBase
    ...
    public const string Cloud_Name = "h2happlication";
    public const string Api_Key = "274181375812265";

    public const string Api_Securit = "0_bkem5BhIaK4lywLhEdYnuxy9Y";
    ...
    // }
    public PhotosController(IDatingRepo repo, IMapper mapper)
    {
      _mapper = mapper;
      _repo = repo;
      Account acc = new Account(Cloud_Name, Api_Key, Api_Securit);
